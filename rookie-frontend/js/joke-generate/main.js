...
function result() {
    ...
    newStory=newStory.replaceAll(':inserta:',xItem).replace(':insertb:',yItem).replace(':insertc:',zItem);
  ...
  if(document.getElementById("american").checked) {
    ...
    temperature+=" 华氏度";
    newStory=newStory.replace("130 公斤",weight).replace("34 摄氏度",temperature);
  }
